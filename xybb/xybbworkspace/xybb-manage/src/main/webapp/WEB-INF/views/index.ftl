...
<head>
    ...
    <![endif]-->
    <title>XYBB后台管理</title>
</head>
<body>
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="${base}/a/index">校园宝贝后台管理系统</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="${base}/a/index">XYBB</a>
                ...
                <ul class="cl">
                    ...
                    <li class="dropDown dropDown_hover">
                        ...
                        <ul class="dropDown-menu menu radius box-shadow">
                            ...
                            <li><a href="${base}/a/logout">退出</a></li>
                        </ul>
                    </li>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a data-href="${base}/applySellerList" data-title="卖家申请" href="javascript:void(0)">卖家申请</a></li>
                    <li><a data-href="${base}/userList" data-title="用户信息管理" href="javascript:void(0)">用户信息管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-picture">
            ...
            <dd>
                <ul>
                    <li><a data-href="${base}/goodsExamine" data-title="商品审核" href="javascript:void(0)">商品审核</a></li>
                    <li><a data-href="${base}/goodsList" data-title="商品信息管理" href="javascript:void(0)">商品信息管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-tongji">
            ...
            <dd>
                <ul>
                    <li><a data-href="${base}/goodsTypeBranch" data-title="商品数量统计" href="javascript:void(0)">商品数量统计</a></li>
                    <li><a data-href="${base}/userBranch" data-title="用户性别分布" href="javascript:void(0)">用户性别分布</a></li>
                    <li><a data-href="${base}/userTypeBranch" data-title="用户类型分布" href="javascript:void(0)">用户类型分布</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-admin">
            ...
            <dd>
                <ul>
                    <li><a data-href="${base}/a/adminList" data-title="管理员列表" href="javascript:void(0)">管理员列表</a></li>
                </ul>
            </dd>
        </dl>
    </div>
...
<section class="Hui-article-box">
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="${base}/a/welcome"></iframe>
        </div>
    </div>
</section>
...
<script type="text/javascript">
    /*个人信息*/
    function myselfinfo(){
        layer_show("查看或修改个人信息",'${base}/a/editSelf',500,500);
    }
