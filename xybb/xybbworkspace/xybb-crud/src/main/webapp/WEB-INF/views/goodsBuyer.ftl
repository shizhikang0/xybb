    ...
    <div class="user-sider fl">
        ...
        <div class="sider-nav">
            <ul>
                ...
                <li><a href="${base}/user/preBuy/${user.id}/1" class="active"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span>&nbsp;&nbsp;我看上的</a></li>
                ...
                <li>
                    ...
                    <div class="list-main clearfix">
                        ...
                        <div class="operation fr">
                            ...
                            <a href="javascript:;" class="delete-want" onclick="cancelPreBuy('${base}/goods/cancelPreBuy/${goodsBuyer.goods.id}')">放弃购买</a>
                            <a href="javascript:;" class="buy-success" onclick="finishBuy('${base}/goods/finishBuy/${goodsBuyer.goods.id}')">购买成功</a>
                        </div>
                    </div>
                </li>
            </#list>
            ...
            <ul class="pagination pagination-lg">
                            <#if pageInfo.pages gt 5 >
                                <#if pageInfo.pageNum lt 4>
                                    <li><a href="${base}/user/preBuy/${user.id}/1">1</a></li>
                                    <li><a href="${base}/user/preBuy/${user.id}/2">2</a></li>
                                    <li><a href="${base}/user/preBuy/${user.id}/3">3</a></li>
                                    <li><a href="${base}/user/preBuy/${user.id}/4">4</a></li>
                                    <li><a href="${base}/user/preBuy/${user.id}/5">5</a></li>
                                    <li>
                                        <a href="${base}/user/preBuy/${user.id}/${pageInfo.nextPage}" aria-label="Next">
                                ...
                                <#if pageInfo.pageNum gte 4>
                                    <li>
                                        <a href="${base}/user/preBuy/${user.id}/${pageInfo.prePage}" aria-label="Previous">
                                            <span aria-hidden="true">&laquo;</span>
                                        </a>
                                    </li>
                                    <#if (pageInfo.pages - pageInfo.pageNum) gte 2>
                                        <li><a href="${base}/user/preBuy/${user.id}/${pageInfo.pageNum-2}">${pageInfo.pageNum-2}</a></li>
                                        <li><a href="${base}/user/preBuy/${user.id}/${pageInfo.pageNum-1}">${pageInfo.pageNum-1}</a></li>
                                        <li><a href="${base}/user/preBuy/${user.id}/${pageInfo.pageNum}">${pageInfo.pageNum}</a></li>
                                        <li><a href="${base}/user/preBuy/${user.id}/${pageInfo.pageNum+1}">${pageInfo.pageNum+1}</a></li>
                                        <li><a href="${base}/user/preBuy/${user.id}/${pageInfo.pageNum+2}">${pageInfo.pageNum+2}</a></li>
                                        <li>
                                            <a href="${base}/user/preBuy/${user.id}/${pageInfo.nextPage}" aria-label="Next">
                                    ...
                                    <#else>
                                        <li><a href="${base}/user/preBuy/${user.id}/${pageInfo.pages-4}">${pageInfo.pages-4}</a></li>
                                        <li><a href="${base}/user/preBuy/${user.id}/${pageInfo.pages-3}">${pageInfo.pages-3}</a></li>
                                        <li><a href="${base}/user/preBuy/${user.id}/${pageInfo.pages-2}">${pageInfo.pages-2}</a></li>
                                        <li><a href="${base}/user/preBuy/${user.id}/${pageInfo.pages-1}">${pageInfo.pages-1}</a></li>
                                        <li><a href="${base}/user/preBuy/${user.id}/${pageInfo.pages}">${pageInfo.pages}</a></li>
                                    </#if>
                                </#if>
                            <#else>
                                <#list 1..pageInfo.pages as pn>
                                    <li><a href="${base}/user/preBuy/${user.id}/${pn}">${pn}</a></li>
                                </#list>
                            </#if>
            </ul>
        </nav>
