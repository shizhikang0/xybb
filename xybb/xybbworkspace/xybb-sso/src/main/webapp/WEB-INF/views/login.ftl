    ...
    <div id="register-main" class="clearfix">
        <div class="layui-tab layui-tab-brief">
            ...
            <div class="layui-tab-content">
                <form class="layui-tab-item layui-form xy-register-content" action="${base}/register">
                ...
                <form id="login_form" class="layui-tab-item layui-show layui-form xy-login-content" action="${base}/login">
                    <div class="layui-form-item">
